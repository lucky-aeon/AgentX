...
/** Neo4j值类型转换器 将Java类型转换为Neo4j支持的类型，特别处理BigDecimal等不支持的类型
 * 
 * @author AgentX */
public class Neo4jValueConverter {
    ...
    public static Object convertValue(Object value) {
        ...
        if (value instanceof List) {
            ...
            return list.stream().map(Neo4jValueConverter::convertValue).collect(Collectors.toList());
        }
    ...
    public static boolean isNeo4jSupportedType(Object value) {
        ...
        return value instanceof String || value instanceof Long || value instanceof Double || value instanceof Boolean
